    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center p-12 space-y-12">
        ...
        <div className="text-center">
          <h3 className="font-display font-extrabold text-2xl text-gray-900 mb-2">Cultivating Plans...</h3>
          <p className="font-sans text-gray-500 animate-pulse">Growing the best routes for your {details.destination} trip.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-8 py-20">
      <div className="mb-20 text-center space-y-4">
        <h2 className="text-4xl md:text-5xl font-display font-extrabold text-gray-900">Your Bloom Plans</h2>
        <p className="font-sans text-lg text-gray-500">We've found 3 kind ways for you to explore the world.</p>
      </div>
        ...
        {itineraries.map((it, idx) => (
          ...
          >
            ...
            <div className="p-8 flex-grow flex flex-col space-y-6">
              <div>
                <h3 className="font-display text-xl font-extrabold text-gray-800 group-hover:text-eco-green transition-colors">{it.title}</h3>
                <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-2">{it.transportMode} • {it.accommodationType}</p>
              </div>
              ...
              <button 
                ...
                className="mt-auto w-full py-4 rounded-soft bg-eco-green-light text-eco-green font-display font-bold transition-all hover:bg-eco-green hover:text-white flex items-center justify-center gap-2"
              >
